...
public:
    ...
    {
        server1_ = this->create_service<example_interfaces::srv::AddTwoInts>
                        ("add_two_ints", std::bind(
                        &AddTwoIntsServerNode::callbackAddTwoInts, this, _1, _2));
...
private:
    ...
    rclcpp::Service<example_interfaces::srv::AddTwoInts>::SharedPtr server1_;
